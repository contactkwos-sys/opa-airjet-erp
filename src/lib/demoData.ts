...
export const DEMO_BY_TABLE: Record<string, Row[]> = {
  ...
  opa_rfqs: [
    {
      id: id("rf", 1),
      rfq_number: `RFQ-${d.replace(/-/g, "")}-001`,
      rfq_date: d,
      due_date: d,
      status: "SUBMITTED",
      remarks: "Spare nozzles and relays",
    },
    {
      id: id("rf", 2),
      rfq_number: `RFQ-${d.replace(/-/g, "")}-002`,
      rfq_date: d,
      due_date: d,
      status: "DRAFT",
      remarks: "40s cotton yarn",
    },
  ],
  opa_supplier_quotations: [
    {
      id: id("sq", 1),
      quotation_number: `SQ-${d.replace(/-/g, "")}-001`,
      rfq_id: id("rf", 1),
      supplier_id: id("su", 2),
      ...
      status: "SUBMITTED",
      is_selected: true,
      remarks: "Main nozzle — 20 pcs",
    },
    {
      id: id("sq", 2),
      quotation_number: `SQ-${d.replace(/-/g, "")}-002`,
      rfq_id: id("rf", 1),
      supplier_id: id("su", 1),
      ...
      status: "SUBMITTED",
      is_selected: false,
      remarks: "Alternate nozzle quote",
    },
    {
      id: id("sq", 3),
      quotation_number: `SQ-${d.replace(/-/g, "")}-003`,
      rfq_id: id("rf", 2),
      supplier_id: id("su", 1),
      supplier_name: "Indo Yarn Traders",
      quotation_date: d,
      ...
      status: "APPROVED",
      is_selected: true,
      remarks: "40s cotton 1200 kg",
    },
  ],
  opa_role_permissions: [
    {
      id: id("rp", 1),
