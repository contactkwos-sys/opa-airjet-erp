    ...
    <div className="login-page">
      <div className="login-card panel">
        <div className="brand login-brand">
          ...
          <h1>Developer Override</h1>
          <p>Emergency / technical access only</p>
        </div>
        ...
        {!showEmailRecovery ? (
          ...
          >
            ...
            <p className="muted pin-hint">
              {submitting ? "Signing in…" : "Enter Developer Override 4-digit PIN"}
            </p>
          ...
          <form className="form-grid" onSubmit={(e) => void onEmailSubmit(e)}>
            <p className="muted recovery-hint">
              Email / password recovery for Developer Override only.
            </p>
            <TextInput
              label="Email"
              type="email"
