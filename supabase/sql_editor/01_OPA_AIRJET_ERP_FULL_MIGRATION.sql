-- =============================================================================
-- OPA AIR JET ERP — FULL SCHEMA MIGRATION (SQL Editor pack)
-- Target: NEW production project "OPA AIR JET ERP" / opa-airjet-erp ONLY
--
-- DO NOT run against: ixulyhomqtajenigopai (wrong / shared CRM-KWOS project)
--
-- How to apply:
--   1. Open Supabase Dashboard → project OPA AIR JET ERP
...
--   • Does not modify CRM/KWOS tables
--   • Role-based RLS; anon revoked on opa_* / security tables
-- =============================================================================

-- >>> BEGIN FILE: 20260814000000_security_visitor_module.sql
-- =============================================================================
...
BEGIN
  ...
  END;
END $$;
-- <<< END FILE: 20260814000000_security_visitor_module.sql

-- >>> BEGIN FILE: 202608140001_opa_core.sql
-- =============================================================================
...
-- <<< END FILE: 202608140001_opa_core.sql

-- >>> BEGIN FILE: 202608140002_opa_production.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140002_opa_production.sql

-- >>> BEGIN FILE: 202608140003_opa_inventory.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140003_opa_inventory.sql

-- >>> BEGIN FILE: 202608140004_opa_purchase_sales.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140004_opa_purchase_sales.sql

-- >>> BEGIN FILE: 202608140005_opa_maintenance_hr.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140005_opa_maintenance_hr.sql

-- >>> BEGIN FILE: 202608140006_opa_security.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140006_opa_security.sql

-- >>> BEGIN FILE: 202608140007_opa_seed.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END FILE: 202608140007_opa_seed.sql

-- >>> BEGIN FILE: 202608140008_opa_rls.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
BEGIN
  ...
  END LOOP;
END $$;
-- <<< END FILE: 202608140008_opa_rls.sql
