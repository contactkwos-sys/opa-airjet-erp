-- =============================================================================
-- OPA AIR JET ERP — REMAINING SQL (chunks 4–10 in one paste)
-- Target ONLY: rjpwznapyaegotbswlke
-- Paste ALL of this into Supabase SQL Editor and Run once.
-- =============================================================================

-- >>> BEGIN chunk_04_opa_inventory.sql
-- =============================================================================
...
-- <<< END chunk_04_opa_inventory.sql

-- >>> BEGIN chunk_05_opa_purchase_sales.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END chunk_05_opa_purchase_sales.sql

-- >>> BEGIN chunk_06_opa_maintenance_hr.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END chunk_06_opa_maintenance_hr.sql

-- >>> BEGIN chunk_07_opa_whatsapp_helpers.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END chunk_07_opa_whatsapp_helpers.sql

-- >>> BEGIN chunk_08_opa_seed.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
-- <<< END chunk_08_opa_seed.sql

-- >>> BEGIN chunk_09_opa_rls.sql
-- =============================================================================
-- OPA Group of India – Air Jet Loom ERP
...
BEGIN
  ...
  END LOOP;
END $$;
-- <<< END chunk_09_opa_rls.sql

-- >>> BEGIN chunk_10_opa_extensions.sql
-- =============================================================================
...
-- <<< END chunk_10_opa_extensions.sql
